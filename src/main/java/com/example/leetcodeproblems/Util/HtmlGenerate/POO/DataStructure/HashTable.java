        ...
        String hashtable = """
                ...
                <p>hashcode = key.hashCode() % table.length</p>
                                 ...
                                 <ul>Sunt 2 tipuri de coleziuni:
                                     ...
                                     <li><h3 class="mb-4"><font size="3">Open addressing</font></h3></li>
                                     ...
                                     <li><h3 class="mb-4"><font size="3">Separate chaining</font></h3></li>
                                     <p>elementul se adauga in celula, ast fel se creaza o lista linkata in celula</p>
                                     <p>Exemplu:</p>
                                     
                                     <img class="center zoom relative" alt="" src="../../../../photo/hashTable/img_2.png" "> 
